...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/11/04 13:39:12 by semartin          #+#    #+#             */
/*   Updated: 2016/05/11 15:10:57 by semartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char				*ft_itoa_base_small(unsigned long long value, int base);
void				ft_itoa_base_cpy(unsigned long long value, int base,
										char *s);
void				ft_itoa_cpy(int n, char *str);
